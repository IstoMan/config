...
map("n", "<leader>e", "<cmd>Oil<CR>", { desc = "Open parent directory", silent = true })
...
end, { desc = "Find symbols in current file", silent = true })
map("n", "<leader>gS", function()
	require("telescope.builtin").lsp_workspace_symbols()
end, { desc = "Find symbols in workspace", silent = true })

-- Lists: quickfix (global) and location list (window-local) helpers.
map("n", "<leader>qo", "<cmd>copen<CR>", { desc = "Open quickfix list", silent = true })
map("n", "<leader>qc", "<cmd>cclose<CR>", { desc = "Close quickfix list", silent = true })
